...
<head>
    ...
    <meta charset="utf-8" />
    <title>Login-Client | SAMELEON GROUP</title>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="p-2">
                                ...
                                <form autocomplete="off" class="form-horizontal"
                                    action="{{ route('client:auth:loginPost') }}" method="post">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="email" class="form-label">Email</label>
                                        <input type="email" name="email"
                                            class="form-control  @error('email') is-invalid @enderror" id="email"
                                            placeholder="Enter email" value="ouhadi@gmail.com">
                                    ...
                                    @if (Route::has('client:auth:forgotpassword'))
                                        <div class="mt-4 text-center">
                                            <a href="{{ route('client:auth:forgotpassword') }}" class="text-muted">
