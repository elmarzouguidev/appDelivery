        ...
        <form  action="{{ route('client:company.store') }}" method="post">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Editer les information du société</p>

                    <div class="row">
                        <div class="col-lg-6">

                            @include('Sameleon.Client.Company.__edit.__info')

                            <div class="col-lg-12">
                                @include('Sameleon.Client.Company.__edit.__date_commande')
                            </div>
                        </div>

                        <div class="col-lg-6">

                            @include('Sameleon.Client.Company.__edit.__select_city')
                            
                            <div class=" mb-4">
                                <label>Siège social *</label>
                                <textarea name="addresse" id="textarea"
                                    class="form-control @error('addresse') is-invalid @enderror" maxlength="225"
                                    rows="5"  required>{{$company->addresse}}</textarea>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-4">
                            @include('Sameleon.Client.Company.__edit.__other')
                        </div>
                    </div>

                </div>
            </div>
            {{--@include('theme.Sameleon.Command.__edit.__condition')--}}
