<div class="row">
    <div class="col-lg-12">
        ...
        @endif
        <form  action="{{ route('client:commands.store') }}" method="post">
            @csrf
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            @include('Sameleon.Client.Command.__create.__info')

                            <div class="col-lg-12">
                                @include('Sameleon.Client.Command.__create.__date_commande')
                            </div>
                        </div>

                        <div class="col-lg-6">

                            @include('Sameleon.Client.Command.__create.__select_city')
