...
@section('content')
    <div class="card">
        <div class="card-body">
            <h4 class="card-title mb-4">Ajouter une vILLE</h4>
            @if (session('success'))
            ...
            @endif
            <form method="post" action="{{ route('sameleon:cities.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row mb-4">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-lg-10">
                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="8"
                            placeholder="Entrer la discription du produit "></textarea>
                        @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-lg-10">
                        <input id="price" name="price" type="number" min="1" placeholder="Entrer le prix du produit"
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-lg-10">
                        <input id="qte_global" name="qte_global" type="number" min="1"
                            ...
                            class="form-control @error('qte_global') is-invalid @enderror" required>
                        @error('qte_global')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
