<div class="email-leftbar card">
    ...
    <div class="mail-list mt-4">
        <a href="javascript: void(0);" class="active"><i class="mdi mdi-email-outline me-2"></i> Tous <span class="ms-1 float-end">({{$count}})</span></a>
        <a href="javascript: void(0);"><i class="mdi mdi-star-outline me-2"></i>Haute</a>
        <a href="javascript: void(0);"><i class="mdi mdi-diamond-stone me-2"></i>Moyenne</a>
        <a href="javascript: void(0);"><i class="mdi mdi-file-outline me-2"></i>Faible</a>
    ...
    <div class="mt-2">
        ...
        <a href="javascript: void(0);" class="d-flex">
            <div class="flex-shrink-0 me-3">
                <img class="rounded-circle" src="{{asset('assets/images/users/avatar-2.jpg')}}" alt="Generic placeholder image" height="36">
            </div>
