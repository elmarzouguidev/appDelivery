                ...
                <form action="{{ route('sameleon:admins.update',$user->uuid) }}" method="post">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-title-desc">Editer les information</p>

                            <div class="row">
                                <div class="col-lg-6">

                                    @include('Sameleon.Admin.Admin.__edit.__info')
                                       
                                </div>

                                <div class="col-lg-6">

                                   @include('Sameleon.Admin.Admin.__edit.__select_city')

                                    <div class=" mb-4">
                                        <label>Adresse *</label>
                                        <textarea name="addresse" id="textarea" class="form-control @error('addresse') is-invalid @enderror"
                                            maxlength="225" rows="5" placeholder="Entrer l'adresse">{{$user->addresse}}</textarea>
