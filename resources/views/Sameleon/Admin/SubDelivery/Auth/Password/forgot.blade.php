...
<head>
    ...
    <meta charset="utf-8" />
    <title>Livreur Mot de pass oublier | SameleonExpress</title>
                    ...
                    <div class="card overflow-hidden">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="p-2">
                                ...
                                <form class="form-horizontal" action="{{ route('forgotpasswordPost.delivery') }}"
                                    method="post">
                                    @csrf
                                    <x-honeypot />
                                    <div class="mb-3">
                                        ...
                                        <input id="useremail" type="email"
                                            ...
                                            value="{{ old('email') }}" placeholder="Entrer vote Email" required
