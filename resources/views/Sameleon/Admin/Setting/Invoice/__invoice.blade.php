            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{route('admin:settings.invoice.store')}}">
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="invoice_prefix" value="{{ $setting->invoice_prefix }}" id="name" required>
                        </div>
                    </div>
                    @csrf
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="number" name="invoice_start" value="{{ $setting->invoice_start }}"
                                id="invoice_start">
                        </div>
                    </div>
