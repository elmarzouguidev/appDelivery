                ...
                <form  wire:submit.prevent="generateBl" method="post" action="{{ route('admin:commands.index') }}">
                    ...
                    @if(isAdmin())
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <select wire:model="blCity" name="city" class="form-control @error('city') is-invalid @enderror"
                                    required>
                    ...
                    <div class="row mb-4">
                        ...
                        <label class="form-label col-lg-2">Livreur *</label>
                        <div class="col-lg-10">
                            <select wire:model.defer="blDelivery" name="delivery" class="form-control @error('delivery') is-invalid @enderror"
                                required>
                                <option value="">Choisir le Livreur</option>
                                @foreach ($blDeliveries as $delivery)
